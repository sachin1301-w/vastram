...
app.post("/make-server-e222e178/contact", async (c) => {
  try {
    ...
    console.log(`Contact form email sent successfully to sk.39648215@gmail.com`);
    ...
    if (resendApiKey) {
      try {
        ...
        const customerEmailResponse = await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            from: 'VASTRAM <onboarding@resend.dev>',
            to: 'sk.39648215@gmail.com', // Send to owner email (Resend free tier limitation)
            subject: `Order Confirmation - ${orderId} - Customer: ${customerInfo.email}`,
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
                <div style="background: linear-gradient(to right, #ea580c, #f59e0b); padding: 30px; text-align: center;">
                  <h1 style="color: #ffffff; margin: 0; font-size: 32px;">VASTRAM</h1>
                  <p style="color: #fef3c7; margin: 10px 0 0 0;">Order Confirmation (Customer Copy)</p>
                </div>
                
                <div style="padding: 30px; background-color: #fefce8; border: 3px solid #f59e0b;">
                  <h2 style="color: #b45309; margin-top: 0;">Order Confirmed! 🎉</h2>
                  <div style="background-color: #dbeafe; padding: 15px; border-radius: 8px; margin: 15px 0; border-left: 4px solid #3b82f6;">
                    <p style="margin: 0; color: #1e40af; font-weight: bold;">📧 This email is for: ${customerInfo.email}</p>
                    <p style="margin: 5px 0 0 0; color: #1e40af; font-size: 12px;">Note: Sent to owner due to Resend email verification requirements. Forward this to customer.</p>
                  </div>
                  <p style="font-size: 16px; color: #374151;">Dear ${customerInfo.firstName} ${customerInfo.lastName},</p>
                  <p style="font-size: 16px; color: #374151;">Your order has been successfully placed! We're excited to get your items to you.</p>
                </div>

                <div style="padding: 30px;">
                  <h3 style="color: #b45309; border-bottom: 2px solid #f59e0b; padding-bottom: 10px;">Order Details</h3>
                  <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                    <thead>
                      <tr style="background-color: #fef3c7;">
                        <th style="padding: 10px; text-align: left; color: #b45309;">Product</th>
                        <th style="padding: 10px; text-align: center; color: #b45309;">Qty</th>
                        <th style="padding: 10px; text-align: right; color: #b45309;">Price</th>
                        <th style="padding: 10px; text-align: right; color: #b45309;">Total</th>
                      </tr>
                    </thead>
                    <tbody>
                      ${itemsListHTML}
                  ...
                  <h3 style="color: #b45309; border-bottom: 2px solid #f59e0b; padding-bottom: 10px; margin-top: 30px;">Shipping Address</h3>
                  <div style="background-color: #f9fafb; padding: 15px; border-radius: 8px; margin: 15px 0;">
                    <p style="margin: 5px 0; color: #374151;"><strong>${customerInfo.firstName} ${customerInfo.lastName}</strong></p>
                    <p style="margin: 5px 0; color: #374151;">${customerInfo.address}</p>
                    <p style="margin: 5px 0; color: #374151;">${customerInfo.city}, ${customerInfo.state} ${customerInfo.zipCode}</p>
                    <p style="margin: 5px 0; color: #374151;">📧 ${customerInfo.email}</p>
                    <p style="margin: 5px 0; color: #374151;">📱 ${customerInfo.phone}</p>
                  </div>
                  ...
                  <div style="background-color: #dcfce7; border-left: 4px solid #16a34a; padding: 15px; margin: 20px 0;">
                    ...
                    <p style="margin: 5px 0 0 0; color: #166534;">We'll send you an email with tracking information once your order ships. You can also track your order anytime in your account.</p>
                  </div>
                </div>

                <div style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 3px solid #f59e0b;">
                  <p style="color: #b45309; font-weight: bold; margin: 0 0 10px 0;">Thank you for shopping with VASTRAM!</p>
        ...
        if (!customerEmailResponse.ok) {
          ...
          console.log(`✅ Order confirmation email (customer copy) sent to owner: sk.39648215@gmail.com (For customer: ${customerInfo.email})`);
        }
        ...
        const adminEmailResponse = await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            from: 'VASTRAM <onboarding@resend.dev>',
            to: 'sk.39648215@gmail.com',
            subject: `🛍️ New Order Received - ${orderId} - ₹${total.toFixed(2)}`,
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
                <div style="background: linear-gradient(to right, #dc2626, #ea580c); padding: 30px; text-align: center;">
                  <h1 style="color: #ffffff; margin: 0; font-size: 32px;">🔔 NEW ORDER ALERT</h1>
                  <p style="color: #fef3c7; margin: 10px 0 0 0;">VASTRAM Admin Dashboard</p>
                </div>
                
                <div style="padding: 30px; background-color: #fef2f2; border: 3px solid #dc2626;">
                  <h2 style="color: #991b1b; margin-top: 0;">New Order Received! 🎉</h2>
                  
                  <div style="background-color: #ffffff; border: 2px solid #dc2626; padding: 15px; margin: 20px 0; border-radius: 8px;">
                    <p style="margin: 0; color: #6b7280; font-size: 14px;">Order ID</p>
                    <p style="margin: 5px 0 0 0; color: #dc2626; font-size: 20px; font-weight: bold; font-family: monospace;">${orderId}</p>
                  </div>
                  ...
                  <div style="background-color: #dcfce7; border: 2px solid #16a34a; padding: 15px; margin: 20px 0; border-radius: 8px; text-align: center;">
                    ...
                    <p style="margin: 5px 0 0 0; color: #16a34a; font-size: 28px; font-weight: bold;">₹${total.toFixed(2)}</p>
                  </div>
                </div>

                <div style="padding: 30px;">
                  <h3 style="color: #991b1b; border-bottom: 2px solid #dc2626; padding-bottom: 10px;">Customer Information</h3>
                  ...
                  <h3 style="color: #991b1b; border-bottom: 2px solid #dc2626; padding-bottom: 10px; margin-top: 30px;">Order Items</h3>
                  <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                    <thead>
                      <tr style="background-color: #fee2e2;">
                        <th style="padding: 10px; text-align: left; color: #991b1b;">Product</th>
                        <th style="padding: 10px; text-align: center; color: #991b1b;">Qty</th>
                        <th style="padding: 10px; text-align: right; color: #991b1b;">Price</th>
                        <th style="padding: 10px; text-align: right; color: #991b1b;">Total</th>
                      </tr>
                    </thead>
                    <tbody>
                      ${itemsListHTML}
                  ...
                  <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0;">
                    ...
                    <p style="margin: 5px 0 0 0; color: #92400e;">Please process this order and update the customer with tracking information.</p>
                  </div>

                  <div style="text-align: center; margin: 30px 0;">
                    <a href="https://your-admin-url.com/admin/dashboard" style="background: linear-gradient(to right, #dc2626, #ea580c); color: #ffffff; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">View in Admin Dashboard</a>
                  </div>
                </div>

                <div style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 3px solid #dc2626;">
                  <p style="color: #991b1b; font-weight: bold; margin: 0 0 10px 0;">VASTRAM Order Management System</p>
                  <p style="color: #6b7280; font-size: 12px; margin: 5px 0;">This is an automated notification from your VASTRAM admin system</p>
                </div>
              </div>
            `,
          }),
        ...
        if (!adminEmailResponse.ok) {
          ...
          console.log(`✅ Order notification email sent to admin: sk.39648215@gmail.com`);
        }
      ...
      console.warn('Resend API key not configured. Order confirmation emails will not be sent.');
    }
